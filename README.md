...
- [DeFi MCP](https://github.com/OzorOwn/defi-mcp) - DeFi data server with 12 tools: token prices, wallet balances across 7 chains, gas prices, DEX swap quotes via Jupiter/1inch, and multi-chain portfolio analytics
