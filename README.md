...
- <img src="https://spawnpay.ai/favicon.ico" height="14"/> [Spawnpay](https://github.com/Robocular/spawnpay) - USDC wallets, payments, and referral earnings for AI agents on Base L2. Auto-creates a wallet on first use (no signup, no KYC). Install: `npx spawnpay-mcp`.
